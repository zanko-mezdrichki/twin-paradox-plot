...
The grafico.py script utilizes the matplotlib library to visualize the world lines of the two twins (Andrew, the stationary twin, and Barney, the traveling twin) and plot the light signals exchanged between them.
